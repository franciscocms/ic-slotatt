...
def clevr_gen_model(observations={"image": torch.zeros((1, 3, 128, 128))}):
    ...
    if not os.path.isdir(os.path.join(dir_path, str(params['jobID']), "gen")): os.mkdir(os.path.join(dir_path, str(params['jobID']), "gen"))
    imgs_path = os.path.join(dir_path, str(params['jobID']), "gen")

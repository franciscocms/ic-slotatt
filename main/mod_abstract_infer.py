...
class TracePosterior(object, metaclass=ABCMeta):
    ...
    def _reset(self):
        ...
        self.prop_traces = [] # new to store the proposed traces from by the guide
    ...
    def run(self, *args, **kwargs):
        ...
        with poutine.block():
            for i, vals in enumerate(self._traces(*args, **kwargs)):
                ...
                self.prop_traces.append(guide_tr) # new to store the proposed traces from by the guide

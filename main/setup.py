...
params = {
    ...
    "num_slots": 10,
    "max_objects": 10,
    "guide_step" : 4000, # !!!!!!!!! 7750 for 2Dobjects - 11050 for clevr6 !!!!!!!!!
    ...
    "strided_convs": True,
    "check_attn": True,
    "jobID": 202, # 69 holds the results for ICSA trained on '2Dobjects' and 87 for only 4 CLEVR objects (95 for 10 slots/objects)
    "mesh_iters": 4,
    "mesh_lr": 5, # 76: 3, 77: 5
    "logprob_coeff": 1.,
